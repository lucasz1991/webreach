<div class="space-y-5">
    <div>
        <h1 class="text-2xl font-semibold text-slate-900">Aktivitaeten</h1>
        <p class="mt-1 text-sm text-slate-600">Status und Nutzeraktivitaet auf Kontoebene verwalten.</p>
    </div>
    ...
    <div class="overflow-hidden rounded-xl border border-slate-200 bg-white">
        <table class="min-w-full divide-y divide-slate-200 text-sm">
            ...
            <tbody class="divide-y divide-slate-200">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-6 text-center text-slate-500">Keine Eintraege gefunden.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
